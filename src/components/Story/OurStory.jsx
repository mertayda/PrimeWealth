      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 font-playfair">
        <div className="flex flex-col space-y-20">
          <div className="text-center relative">
            <h2 className="inline-block px-6 py-3 bg-gradient-to-r from-green-400 to-purple-500 text-white text-2xl font-semibold rounded-full mb-6 relative z-10 transform hover:scale-105 transition-transform duration-300">
              Our Story
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-12">
              {[
                ...
                },
                {
                  ...
                  icon: <Phone className="w-10 h-10 text-purple-500" />,
